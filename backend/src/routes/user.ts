  ...
  try {
    ...
    const profile = await prisma.userProfile.upsert({
      ...
      update: {
        ...
        ...(data.horseDetails !== undefined && { horseDetails: data.horseDetails }),
        ...(data.returningTimeGap !== undefined && { returningTimeGap: data.returningTimeGap }),
        ...(data.horseAccess !== undefined && { horseAccess: data.horseAccess }),
        methodPreference: data.methodPreference || 'explore',
        ...(data.selectedMethods !== undefined && { selectedMethods: data.selectedMethods }),
        updatedAt: new Date(),
      },
      create: {
        userId: req.userId!,
